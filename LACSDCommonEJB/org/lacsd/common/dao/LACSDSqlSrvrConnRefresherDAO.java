...
public class LACSDSqlSrvrConnRefresherDAO extends LACSDSqlServerSqlDAO {
...
public LACSDSqlSrvrConnRefresherDAO() {
	super();
}

public LACSDSqlSrvrConnRefresherDAO(String otherDatabaseName) {
...
private String buildRefreshInput() {
	StringBuffer sql = new StringBuffer("SELECT GETDATE()");
	return sql.toString();
}
