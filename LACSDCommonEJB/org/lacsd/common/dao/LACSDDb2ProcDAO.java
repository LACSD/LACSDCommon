...
//* Filename:		LACSDDb2ProcDAO.java
//* Revision: 		1.0
//* Author:			M Feinberg
//* Created On: 	07-08-2003
//* Modified By:	M Feinberg, T Nguyen
//* Modified On:	11-06-2003
//*					
//* Description:	Abstract core class for handling DB2  * STORED PROCEDURES *
//*
//*					<code>11-06-2003</code> Added Log4J Config File Support
//*
//* 				<code>12-17-2003</code> Major clean-up to improve readability
//*
//*                 <code>04-15-2004</code> Fix DAO to handle a parameter of 
//*                                         Timestamp object
//* 
/******************************************************************************/
...
public abstract class LACSDDb2ProcDAO extends LACSDDb2DAO {
 ...
 * @param String spname
*/
public LACSDDb2ProcDAO(String spName) {
	super();
...
*/
public LACSDDb2ProcDAO(String spName, boolean useLogging) {
	this(spName);
...
private void registerStatement(CallableStatement statement) throws SQLException, LACSDException {
	...
	while (it.hasNext()) {
		...
		if (type instanceof String) {
            ...
            byte[] input = ( byte[])type;
            statement.setBytes(pos,input);
        }
		else {
